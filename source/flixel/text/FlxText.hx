...
class FlxText extends FlxSprite
{
	 ...
	 */
	public function new(X:Float = 0, Y:Float = 0, FieldWidth:Float = 0, ?Text:String, Size:Int = 12, EmbeddedFont:Bool = true)
	{
		super(X, Y);
		...
		font = Paths.font('phantommuff.ttf'); // Default Global Font!!!
