...
import haxe.Json;
import funkin.animateatlas.tilecontainer.TileAnimationLibrary;
import funkin.animateatlas.tilecontainer.TileContainerMovieClip;
import funkin.animateatlas.displayobject.SpriteAnimationLibrary;
import funkin.animateatlas.displayobject.SpriteMovieClip;
