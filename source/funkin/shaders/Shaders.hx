...
class VignetteEffect extends Effect
{
	...
	public function new(?intensityMultiplier:Float = 1.0) {
		shader.uTime.value = [0];
	...
	public function setIntensity(value:Float) {
		shader.intensityMultiplier.value[0] = value;
	}
}
...
class BloomEffect extends Effect
{
	...
	public function new(size:Float, intensity:Float)
	{
		shader.blurSize.value = [size];
